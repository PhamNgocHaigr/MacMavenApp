...
public class StatusProcessingFragment extends Fragment {
    RecyclerView rvAllOrder;
    OrderAdapter orderAdapter;
    List<Order> orderList;

    public StatusProcessingFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_order_status_processing, container, false);
    }
    ...
    private void LoadData() {
        ...
        OrderAPI.orderAPI.getOrderByStatus("processing", user.getId()).enqueue(new Callback<List<Order>>() {
            @Override
...
//                Log.e("=====", response.body().toString());
    ...
    private void AnhXa() {
        rvAllOrder = getView().findViewById(R.id.rvStatusProcessing);
    }
}