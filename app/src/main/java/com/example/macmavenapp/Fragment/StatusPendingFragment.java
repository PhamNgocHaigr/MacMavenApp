...
public class StatusPendingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_order_status_pending, container, false);
    }
    ...
    private void LoadData() {
        ...
        OrderAPI.orderAPI.getOrderByStatus("pending", user.getId()).enqueue(new Callback<List<Order>>() {
            @Override
...
//                Log.e("=====", response.body().toString());
    ...
    private void AnhXa() {
        rvAllOrder = getView().findViewById(R.id.rvStatusPending);
    }
}