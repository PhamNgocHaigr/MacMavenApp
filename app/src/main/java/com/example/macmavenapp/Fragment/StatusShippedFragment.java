...
public class StatusShippedFragment extends Fragment {
    RecyclerView rvAllOrder;
    OrderAdapter orderAdapter;
    List<Order> orderList;

    public StatusShippedFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_order_status_shipped, container, false);
    }
    ...
    private void LoadData() {
        ...
        OrderAPI.orderAPI.getOrderByStatus("shipped", user.getId()).enqueue(new Callback<List<Order>>() {
            @Override
...
//                Log.e("=====", response.body().toString());
    ...
    private void AnhXa() {
        rvAllOrder = getView().findViewById(R.id.rvStatusShipped);
    }
}
