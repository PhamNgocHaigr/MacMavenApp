...
public class StatusCompletedFragment extends Fragment {
    RecyclerView rvAllOrder;
    OrderAdapter orderAdapter;
    List<Order> orderList;

    public StatusCompletedFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_order_status_completed, container, false);
    }
    ...
    private void LoadData() {
        ...
        OrderAPI.orderAPI.getOrderByStatus("completed", user.getId()).enqueue(new Callback<List<Order>>() {
            @Override
...
//                Log.e("=====", response.body().toString());
    ...
    private void AnhXa() {
        rvAllOrder = getView().findViewById(R.id.rvStatusCompleted);
    }
}