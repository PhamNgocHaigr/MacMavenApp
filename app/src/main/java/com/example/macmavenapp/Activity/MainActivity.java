...
import com.example.macmavenapp.Adapter.CartAdapter;
import com.example.macmavenapp.Adapter.CategoryAdapter;
...
import com.example.macmavenapp.Retrofit.CategoryAPI;
...
public class MainActivity extends AppCompatActivity {
    ...
    TextView tvHiName ,tvSeeAllNewProducts, tvSeeAllBestSeller,tvCountCart;
    EditText etSearch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoadBestSellers();
        ivSearchClick();
        tvSeeAllNewProductsClick();
        tvSeeAllBestSellerClick();
//        LoadCartofUser();
    }
    ...
    private void tvSeeAllNewProductsClick() {
        tvSeeAllNewProducts.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, ProductsActivity.class);
                intent.putExtra("showNewProducts", "showNewProducts");
                startActivity(intent);
            }
        });
    }
    private void tvSeeAllBestSellerClick() {
        tvSeeAllBestSeller.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, ProductsActivity.class);
                intent.putExtra("showBestSellers", "showBestSellers");
                startActivity(intent);
            }
        });
    }
    ...
    private void LoadUserInfor() {
        ...
        tvHiName.setText(user.getUser_Name());
    ...
    private void AnhXa() {
        ...
        tvSeeAllNewProducts = findViewById(R.id.tvSeeAllNewProducts);
        tvSeeAllBestSeller = findViewById(R.id.tvSeeAllBestSeller);
    }
}